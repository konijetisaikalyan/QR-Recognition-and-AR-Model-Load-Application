...
import { Camera as BabylonjsCoreCamera, IObliqueParams as BabylonjsCoreIObliqueParams } from '@babylonjs/core/Cameras/camera.js';
...
import { AxisDragGizmo as BabylonjsCoreAxisDragGizmo, IAxisDragGizmo as BabylonjsCoreIAxisDragGizmo } from '@babylonjs/core/Gizmos/axisDragGizmo.js';
import { AxisScaleGizmo as BabylonjsCoreAxisScaleGizmo, IAxisScaleGizmo as BabylonjsCoreIAxisScaleGizmo } from '@babylonjs/core/Gizmos/axisScaleGizmo.js';
import { BoundingBoxGizmo as BabylonjsCoreBoundingBoxGizmo, IBoundingBoxGizmo as BabylonjsCoreIBoundingBoxGizmo } from '@babylonjs/core/Gizmos/boundingBoxGizmo.js';
import { CameraGizmo as BabylonjsCoreCameraGizmo } from '@babylonjs/core/Gizmos/cameraGizmo.js';
import { Gizmo as BabylonjsCoreGizmo, GizmoAnchorPoint as BabylonjsCoreGizmoAnchorPoint, GizmoCoordinatesMode as BabylonjsCoreGizmoCoordinatesMode } from '@babylonjs/core/Gizmos/gizmo.js';
...
import { IPlaneDragGizmo as BabylonjsCoreIPlaneDragGizmo, PlaneDragGizmo as BabylonjsCorePlaneDragGizmo } from '@babylonjs/core/Gizmos/planeDragGizmo.js';
import { IPlaneRotationGizmo as BabylonjsCoreIPlaneRotationGizmo, PlaneRotationGizmo as BabylonjsCorePlaneRotationGizmo } from '@babylonjs/core/Gizmos/planeRotationGizmo.js';
import { IPositionGizmo as BabylonjsCoreIPositionGizmo, PositionGizmo as BabylonjsCorePositionGizmo, PositionGizmoOptions as BabylonjsCorePositionGizmoOptions } from '@babylonjs/core/Gizmos/positionGizmo.js';
import { IRotationGizmo as BabylonjsCoreIRotationGizmo, RotationGizmo as BabylonjsCoreRotationGizmo, RotationGizmoOptions as BabylonjsCoreRotationGizmoOptions } from '@babylonjs/core/Gizmos/rotationGizmo.js';
import { IScaleGizmo as BabylonjsCoreIScaleGizmo, ScaleGizmo as BabylonjsCoreScaleGizmo, ScaleGizmoOptions as BabylonjsCoreScaleGizmoOptions } from '@babylonjs/core/Gizmos/scaleGizmo.js';
...
import { Effect as BabylonjsCoreEffect, IShaderPath as BabylonjsCoreIShaderPath } from '@babylonjs/core/Materials/effect.js';
...
import { CubeTexture as BabylonjsCoreCubeTexture, ICubeTextureCreationOptions as BabylonjsCoreICubeTextureCreationOptions } from '@babylonjs/core/Materials/Textures/cubeTexture.js';
...
import { CustomProceduralTexture as BabylonjsCoreCustomProceduralTexture, ICustomProceduralTextureCreationOptions as BabylonjsCoreICustomProceduralTextureCreationOptions } from '@babylonjs/core/Materials/Textures/Procedurals/customProceduralTexture.js';
...
import { IProceduralTextureCreationOptions as BabylonjsCoreIProceduralTextureCreationOptions, ProceduralTexture as BabylonjsCoreProceduralTexture } from '@babylonjs/core/Materials/Textures/Procedurals/proceduralTexture.js';
...
import { RenderTargetTexture as BabylonjsCoreRenderTargetTexture, RenderTargetTextureOptions as BabylonjsCoreRenderTargetTextureOptions } from '@babylonjs/core/Materials/Textures/renderTargetTexture.js';
...
import { IColor4Like as BabylonjsCoreIColor4Like, IVector3Like as BabylonjsCoreIVector3Like } from '@babylonjs/core/Maths/math.like.js';
...
import { GreasedLineBaseMesh as BabylonjsCoreGreasedLineBaseMesh, GreasedLineMeshOptions as BabylonjsCoreGreasedLineMeshOptions } from '@babylonjs/core/Meshes/GreasedLine/greasedLineBaseMesh.js';
...
import { IPhysicsEnabledObject as BabylonjsCoreIPhysicsEnabledObject, PhysicsImpostor as BabylonjsCorePhysicsImpostor, PhysicsImpostorParameters as BabylonjsCorePhysicsImpostorParameters } from '@babylonjs/core/Physics/v1/physicsImpostor.js';
import { PhysicsShapeType as BabylonjsCorePhysicsShapeType } from '@babylonjs/core/Physics/v2/IPhysicsEnginePlugin.js';
import { PhysicsAggregate as BabylonjsCorePhysicsAggregate, PhysicsAggregateParameters as BabylonjsCorePhysicsAggregateParameters } from '@babylonjs/core/Physics/v2/physicsAggregate.js';
...
import { Scene as BabylonjsCoreScene, ScenePerformancePriority as BabylonjsCoreScenePerformancePriority } from '@babylonjs/core/scene.js';
import { Sprite as BabylonjsCoreSprite } from '@babylonjs/core/Sprites/sprite.js';
import { ISpriteManager as BabylonjsCoreISpriteManager, SpriteManager as BabylonjsCoreSpriteManager } from '@babylonjs/core/Sprites/spriteManager.js';
...
import { Button3D as BabylonjsGuiButton3D, IButton3DCreationOptions as BabylonjsGuiIButton3DCreationOptions } from '@babylonjs/gui/3D/controls/button3D.js';
...
declare global {
    namespace JSX {
        interface IntrinsicElements {
            ...
            greasedLineBaseMesh: FiberGreasedLineBaseMeshProps & FiberGreasedLineBaseMeshPropsCtor & BabylonNode<BabylonjsCoreGreasedLineBaseMesh>;
            greasedLineMesh: FiberGreasedLineMeshProps & FiberGreasedLineMeshPropsCtor & BabylonNode<BabylonjsCoreGreasedLineMesh>;
            greasedLineRibbonMesh: FiberGreasedLineRibbonMeshProps & FiberGreasedLineRibbonMeshPropsCtor & BabylonNode<BabylonjsCoreGreasedLineRibbonMesh>;
            gaussianSplattingMesh: FiberGaussianSplattingMeshProps & FiberGaussianSplattingMeshPropsCtor & BabylonNode<BabylonjsCoreGaussianSplattingMesh>;
            ...
            greasedLineSimpleMaterial: FiberGreasedLineSimpleMaterialProps & FiberGreasedLineSimpleMaterialPropsCtor & BabylonNode<BabylonjsCoreGreasedLineSimpleMaterial>;
            ...
            gaussianSplattingMaterial: FiberGaussianSplattingMaterialProps & FiberGaussianSplattingMaterialPropsCtor & BabylonNode<BabylonjsCoreGaussianSplattingMaterial>;
            ...
            mrdlBackglowMaterial: FiberMRDLBackglowMaterialProps & FiberMRDLBackglowMaterialPropsCtor & BabylonNode<BabylonjsGuiMRDLBackglowMaterial>;
            mrdlFrontplateMaterial: FiberMRDLFrontplateMaterialProps & FiberMRDLFrontplateMaterialPropsCtor & BabylonNode<BabylonjsGuiMRDLFrontplateMaterial>;
            mrdlInnerquadMaterial: FiberMRDLInnerquadMaterialProps & FiberMRDLInnerquadMaterialPropsCtor & BabylonNode<BabylonjsGuiMRDLInnerquadMaterial>;
            ...
            inputTextArea: FiberInputTextAreaProps & FiberInputTextAreaPropsCtor & BabylonNode<BabylonjsGuiInputTextArea>;
            ...
            spriteManager: FiberSpriteManagerProps & FiberSpriteManagerPropsCtor & BabylonNode<BabylonjsCoreSpriteManager>;
            spritePackedManager: FiberSpritePackedManagerProps & FiberSpritePackedManagerPropsCtor & BabylonNode<BabylonjsCoreSpritePackedManager>;
            thinSprite: FiberThinSpriteProps & FiberThinSpritePropsCtor & BabylonNode<BabylonjsCoreThinSprite>;
            ...
            xrSpaceWarpRenderTarget: FiberXRSpaceWarpRenderTargetProps & FiberXRSpaceWarpRenderTargetPropsCtor & BabylonNode<BabylonjsCoreXRSpaceWarpRenderTarget>;
            ...
            ssrRenderingPipeline: FiberSSRRenderingPipelineProps & FiberSSRRenderingPipelinePropsCtor & BabylonNode<BabylonjsCoreSSRRenderingPipeline>;
            taaRenderingPipeline: FiberTAARenderingPipelineProps & FiberTAARenderingPipelinePropsCtor & BabylonNode<BabylonjsCoreTAARenderingPipeline>;
            iblShadowsRenderPipeline: FiberIblShadowsRenderPipelineProps & BabylonNode<BabylonjsCoreIblShadowsRenderPipeline>;
            ...
            physicsAggregate: FiberPhysicsAggregateProps & FiberPhysicsAggregatePropsCtor & BabylonNode<BabylonjsCorePhysicsAggregate>;
            ...
            pbrIridescenceConfiguration: FiberPBRIridescenceConfigurationProps & FiberPBRIridescenceConfigurationPropsCtor & BabylonNode<BabylonjsCorePBRIridescenceConfiguration>;
...
export type FiberGreasedLineRibbonMeshPropsCtor = {
    ...
    _options: BabylonjsCoreGreasedLineMeshOptions;
    _pathOptions?: {
        options: BabylonjsCoreGreasedLineMeshOptions;
        pathCount: number;
    }[];
};
...
export type FiberRenderTargetTextureProps = {
    ...
    customIsReadyFunction?: (mesh: BabylonjsCoreAbstractMesh, refreshRate: number, preWarm?: boolean) => boolean;
...
export type FiberSceneProps = {
    ...
    pointerDownTrianglePredicate?: (p0: BabylonjsCoreVector3, p1: BabylonjsCoreVector3, p2: BabylonjsCoreVector3, ray: BabylonjsCoreRay) => boolean;
    ...
    pointerUpTrianglePredicate?: (p0: BabylonjsCoreVector3, p1: BabylonjsCoreVector3, p2: BabylonjsCoreVector3, ray: BabylonjsCoreRay) => boolean;
    pointerX?: number;
    pointerY?: number;
